// 请求url的路径（pathname）第一个目录为请求资源类型, 通过资源类型区分请求类型, static: 静态资源, interface: 接口请求, img: 库储存图片;
...
function parseURL(url) {
    ...
    if (pathName === '/') {
        ...
        if (key) key = path.basename(key, extName);
    }
